...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_svelte_cookie: string;
	export const npm_package_dependencies__emotion_css: string;
	export const npm_package_dependencies__smui_button: string;
	export const npm_package_dependencies__smui_card: string;
	...
	export const npm_package_devDependencies__types_axios: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_svelte_cookie: string;
		npm_package_dependencies__emotion_css: string;
		npm_package_dependencies__smui_button: string;
		npm_package_dependencies__smui_card: string;
		...
		npm_package_devDependencies__types_axios: string;
