...
class PresentationHistory(db.Model):
    ...
    user_email = db.Column(db.String(120), nullable=False)  # Add this line
...
def generate():
    ...
    user_email = request_data.get('email')  # Get the user email from the request
    ...
    new_presentation = PresentationHistory(
        ...
        user_email=user_email  # Save the user email
    )
...
def delete_history():
    try:
        ...
        print("Data received:", data)  # Log untuk debug
